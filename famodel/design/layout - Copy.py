...
# copying and modifying from helpers
...
if __name__ == '__main__':
    ...
    '''
    newFile = 'layoutdemo/newfile.yaml' # '..\scripts\input_files\GoMxOntology.yaml'
    project = Project(file=newFile,raft=0)
    project.getMoorPyArray()
    ss = deepcopy(project.ms.lineList[0])      
    '''
    # MH: alternative simplified approach for getting a Mooring Subsystem
    
    from moorpy.helpers import loadLineProps
    from famodel.helpers import loadYAML  #, getMoorings
    
    d = loadYAML('layoutdemo/layout_inputs.yaml')  # simplified layout input yaml
